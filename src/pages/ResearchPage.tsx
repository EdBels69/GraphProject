    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Автоматический сбор литературы</h1>
                    <p className="text-gray-600">
                        Введите тему исследования — агент найдет статьи, скачает их и построит граф знаний
                    </p>
                </div>
            </div>
